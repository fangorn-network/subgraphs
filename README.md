...
1. From the appropriate contract in the [contracts] repo, generate the ABI that you need and copy it into the abis directory of the corresponding subgraph project.
