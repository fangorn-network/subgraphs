...
export type FileField_OrderBy = 'acc' | 'atType' | 'file' | 'file__id' | 'file__tag' | 'id' | 'name' | 'pricing' | 'pricing__currency' | 'pricing__id' | 'pricing__owner' | 'pricing__price' | 'value';
...
export type File_OrderBy = 'fileFields' | 'id' | 'manifest' | 'manifest__id' | 'manifest__manifestVersion' | 'manifest__schemaId' | 'tag';
...
export type ManifestPublished_OrderBy = 'blockNumber' | 'blockTimestamp' | 'id' | 'manifestCid' | 'owner' | 'schemaId' | 'transactionHash' | 'version';
export type ManifestState = {
    __typename?: 'ManifestState';
    id: Scalars['Bytes']['output'];
...
export type ManifestState_OrderBy = 'id' | 'lastUpdated' | 'manifest' | 'manifestCid' | 'manifest__id' | 'manifest__manifestVersion' | 'manifest__schemaId' | 'owner' | 'schema' | 'schemaId' | 'schemaName' | 'schema__agentId' | 'schema__id' | 'schema__version' | 'version';
export type ManifestUpdated = {
    __typename?: 'ManifestUpdated';
    blockNumber: Scalars['BigInt']['output'];
    blockTimestamp: Scalars['BigInt']['output'];
    id: Scalars['Bytes']['output'];
    manifestCid: Scalars['String']['output'];
...
export type ManifestUpdated_OrderBy = 'blockNumber' | 'blockTimestamp' | 'id' | 'manifestCid' | 'owner' | 'schemaId' | 'transactionHash' | 'version';
...
export type Manifest_OrderBy = 'files' | 'id' | 'manifestState' | 'manifestState__id' | 'manifestState__lastUpdated' | 'manifestState__manifestCid' | 'manifestState__owner' | 'manifestState__schemaId' | 'manifestState__schemaName' | 'manifestState__version' | 'manifestVersion' | 'schemaId';
/** Defines the order direction, either ascending or descending */
export type OrderDirection = 'asc' | 'desc';
export type PriceUpdated = {
    __typename?: 'PriceUpdated';
    id: Scalars['Bytes']['output'];
    owner: Scalars['Bytes']['output'];
...
export type PriceUpdated_OrderBy = 'id' | 'owner' | 'price' | 'resourceId';
export type PricingResource = {
    __typename?: 'PricingResource';
...
export type PricingResource_OrderBy = 'currency' | 'id' | 'owner' | 'price';
export type Query = {
    __typename?: 'Query';
...
export type ResourceCreated_OrderBy = 'groupId' | 'id' | 'owner' | 'price' | 'resourceId';
export type Schema = {
    __typename?: 'Schema';
...
export type SchemaField_OrderBy = 'fieldType' | 'id' | 'name';
export type SchemaRegistered = {
    __typename?: 'SchemaRegistered';
...
export type SchemaRegistered_OrderBy = 'agentId' | 'id' | 'ipfsCid' | 'name' | 'owner' | 'schemaId';
export type SchemaState = {
    __typename?: 'SchemaState';
    id: Scalars['Bytes']['output'];
    name: Scalars['String']['output'];
    owner: Scalars['Bytes']['output'];
    schemaId: Scalars['Bytes']['output'];
...
export type SchemaState_OrderBy = 'id' | 'name' | 'owner' | 'schemaId' | 'versions';
export type SchemaUpdated = {
    __typename?: 'SchemaUpdated';
    id: Scalars['Bytes']['output'];
...
export type SchemaUpdated_OrderBy = 'id' | 'newAgentId' | 'newIpfsCid' | 'schemaId';
...
export type Schema_OrderBy = 'agentId' | 'fields' | 'id' | 'manifests' | 'version';
export type _Block_ = {
    __typename?: '_Block_';
...
export type GetFileByFileFieldIdQuery = {
    __typename?: 'Query';
    fileFields: Array<{
        __typename?: 'FileField';
        file: {
...
export type GetPriceByFileFieldIdQuery = {
    __typename?: 'Query';
    fileFields: Array<{
        __typename?: 'FileField';
        pricing?: {
...
export type GetFileFieldsByFileIdQuery = {
    __typename?: 'Query';
    files: Array<{
        __typename?: 'File';
        fileFields?: Array<{
...
export type SchemaStateCoreFragment = {
    __typename?: 'SchemaState';
    id: string;
    schemaId: string;
    owner: string;
...
export type SchemaStateWithFieldsFragment = {
    __typename?: 'SchemaState';
    id: string;
    schemaId: string;
    owner: string;
...
export type SchemaStateWithManifestsFragment = {
    __typename?: 'SchemaState';
    id: string;
    schemaId: string;
    owner: string;
...
export type SchemaStateFragment = {
    __typename?: 'SchemaState';
    id: string;
    schemaId: string;
    owner: string;
...
export type SchemaCoreFragment = {
    __typename?: 'Schema';
    id: string;
    version?: string | null;
    agentId?: string | null;
};
export type SchemaWithFieldsFragment = {
    __typename?: 'Schema';
    id: string;
    version?: string | null;
    agentId?: string | null;
...
export type SchemaWithManifestsFragment = {
    __typename?: 'Schema';
    id: string;
    version?: string | null;
    agentId?: string | null;
...
export type SchemaFieldFragment = {
    __typename?: 'SchemaField';
    id: string;
    name: string;
    fieldType: string;
};
export type ManifestStateCoreFragment = {
    __typename?: 'ManifestState';
    id: string;
    owner: string;
    schemaId: string;
...
export type ManifestStateFragment = {
    __typename?: 'ManifestState';
    id: string;
    owner: string;
    schemaId: string;
...
export type ManifestCoreFragment = {
    __typename?: 'Manifest';
    id: string;
    manifestVersion?: string | null;
    schemaId?: string | null;
...
export type FileFieldCoreFragment = {
    __typename?: 'FileField';
    id: string;
    name?: string | null;
    value?: string | null;
...
export type PricingResourceFragment = {
    __typename?: 'PricingResource';
    id: string;
    owner: string;
    price: string;
...
export type ManifestByFileFragment = {
    __typename?: 'File';
    manifest: {
        __typename?: 'Manifest';
        id: string;
...
export type FileByFileFieldFragment = {
    __typename?: 'FileField';
    file: {
        __typename?: 'File';
        fileFields?: Array<{
...
export type GetManifestStatesBySchemaNameQuery = {
    __typename?: 'Query';
    manifestStates: Array<{
        __typename?: 'ManifestState';
        id: string;
        owner: string;
        schemaId: string;
...
export type GetManifestByIdQuery = {
    __typename?: 'Query';
    manifests: Array<{
        __typename?: 'Manifest';
        id: string;
...
export type GetManifestByFileFieldIdQuery = {
    __typename?: 'Query';
    fileFields: Array<{
        __typename?: 'FileField';
        file: {
...
export type GetManifestByFileIdQuery = {
    __typename?: 'Query';
    files: Array<{
        __typename?: 'File';
        manifest: {
...
export type GetAllSchemaStatesQuery = {
    __typename?: 'Query';
    schemaStates: Array<{
        __typename?: 'SchemaState';
        id: string;
...
export type GetAllSchemaStatesByOwnerQuery = {
    __typename?: 'Query';
    schemaStates: Array<{
        __typename?: 'SchemaState';
        id: string;
...
export type GetSchemaStateByNameQuery = {
    __typename?: 'Query';
    schemaStates: Array<{
        __typename?: 'SchemaState';
        id: string;
...
export type GetSchemasBySchemaIdQuery = {
    __typename?: 'Query';
    schemaStates: Array<{
        __typename?: 'SchemaState';
        id: string;
...
export declare const SchemaStateCoreFragmentDoc: import("graphql").DocumentNode;
export declare const SchemaCoreFragmentDoc: import("graphql").DocumentNode;
export declare const SchemaFieldFragmentDoc: import("graphql").DocumentNode;
export declare const SchemaWithFieldsFragmentDoc: import("graphql").DocumentNode;
export declare const SchemaStateWithFieldsFragmentDoc: import("graphql").DocumentNode;
export declare const ManifestStateCoreFragmentDoc: import("graphql").DocumentNode;
export declare const ManifestCoreFragmentDoc: import("graphql").DocumentNode;
export declare const FileCoreFragmentDoc: import("graphql").DocumentNode;
export declare const FileFieldCoreFragmentDoc: import("graphql").DocumentNode;
export declare const PricingResourceFragmentDoc: import("graphql").DocumentNode;
export declare const FileFieldFragmentDoc: import("graphql").DocumentNode;
export declare const FileFragmentDoc: import("graphql").DocumentNode;
export declare const ManifestFragmentDoc: import("graphql").DocumentNode;
export declare const ManifestStateFragmentDoc: import("graphql").DocumentNode;
export declare const SchemaWithManifestsFragmentDoc: import("graphql").DocumentNode;
export declare const SchemaStateWithManifestsFragmentDoc: import("graphql").DocumentNode;
export declare const SchemaFragmentDoc: import("graphql").DocumentNode;
export declare const SchemaStateFragmentDoc: import("graphql").DocumentNode;
export declare const ManifestByFileFieldFragmentDoc: import("graphql").DocumentNode;
export declare const ManifestByFileFragmentDoc: import("graphql").DocumentNode;
export declare const FileByFileFieldFragmentDoc: import("graphql").DocumentNode;
export declare const GetFileByFileFieldIdDocument: import("graphql").DocumentNode;
export declare const GetFileByFileFieldNameValuePairDocument: import("graphql").DocumentNode;
export declare const GetFileEntriesByManifestIdDocument: import("graphql").DocumentNode;
export declare const GetPriceByFileFieldIdDocument: import("graphql").DocumentNode;
export declare const GetFileFieldsByFileIdDocument: import("graphql").DocumentNode;
export declare const GetManifestStatesBySchemaNameDocument: import("graphql").DocumentNode;
export declare const GetManifestStatesBySchemaNameAndOwnerDocument: import("graphql").DocumentNode;
export declare const GetManifestStatesBySchemaIdDocument: import("graphql").DocumentNode;
export declare const GetManifestByIdDocument: import("graphql").DocumentNode;
export declare const GetManifestByFileFieldIdDocument: import("graphql").DocumentNode;
export declare const GetManifestByFileIdDocument: import("graphql").DocumentNode;
export declare const GetManifestByFileFieldNameValuePairDocument: import("graphql").DocumentNode;
export declare const GetAllSchemaStatesDocument: import("graphql").DocumentNode;
export declare const GetAllSchemaStatesByOwnerDocument: import("graphql").DocumentNode;
export declare const GetSchemaStateByNameDocument: import("graphql").DocumentNode;
export declare const GetSchemasBySchemaIdDocument: import("graphql").DocumentNode;
